...
double GeoController::CalculateBearingAngle(double latitude, double longitude, GeoGPS geo_gps)
{
...
double GeoController::CalculateDistance(double latitude, double longitude, GeoGPS geo_gps)
{
    //printf("\n1:lat:%f long:%f\n", geo_gps.GetLatitude(), geo_gps.GetLongitude());
    //printf("\n2:lat:%f long:%f\n", latitude, longitude);
    latitude = DegreeToRadian(/*48.1173);//*/latitude);
    longitude = DegreeToRadian(/*11.5167);//*/longitude);
